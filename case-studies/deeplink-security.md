...
The platform's deep-linking service allows applications to hand off a user to another application, carrying context, such as user identity, session state, and the current flow, across the boundary.
