...
- **Phase 1: Scoping and architecture.** Team: me, manager, 2 designers, BA
- **Phase 2: Core development.** Team: me, manager; front-end developer built the initial UI as designed but left the project as the scope shifted toward integration work; I took over the UI layer as the flows developed
- **Phase 3: Integration and redesign.** Team: me solo, manager in background
- **Phase 4: Post-launch.** Team: me, manager, junior developer (bugs and roadmapped features)
